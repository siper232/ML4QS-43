...
DATASET_FNAME = 'chapter3_result_final_owndataset.csv'
RESULT_FNAME = 'chapter4_result_owndataset.csv'
...
def main():
    ...
    if FLAGS.mode == 'final':
        ...
        DataViz.plot_dataset(dataset, ['acc_phone_x', 'gyr_phone_x',  'mag_phone_x', 'press_phone_', 'pca_1'], ['like', 'like', 'like', 'like', 'like'], ['line', 'line', 'line', 'line', 'line'])
        ...
        periodic_predictor_cols = ['acc_phone_x','acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z','mag_phone_x','mag_phone_y','mag_phone_z']
