...
DATASET_FNAME = 'chapter3_result_outliers_owndataset.csv'
RESULT_FNAME = 'chapter3_result_final_owndataset.csv'
ORIG_DATASET_FNAME = 'chapter2_result_owndataset.csv'
...
def main():
    ...
    if FLAGS.mode == 'imputation':
        ...
        DataViz.plot_dataset(dataset, ['acc_', 'gyr_', 'press_phone_X (hPa)',  'mag_', 'press_phone_X (hPa)'],
                             ['like', 'like',  'like', 'like',
                                 'like', 'like'],
