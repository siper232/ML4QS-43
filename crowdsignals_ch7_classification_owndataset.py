...
DATASET_FNAME = 'chapter5_result_owndataset.csv'
RESULT_FNAME = 'chapter7_classification_result_owndataset.csv'
EXPORT_TREE_PATH = Path('./figures/crowdsignals_ch7_classification_owndataset/')
